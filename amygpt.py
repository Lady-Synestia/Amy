...
class AmyGPT:
    ...
    def get_new_status(self):
        return self.make_request(role="developer", content=self.__GPT_STATUS_MESSAGE)

    def make_request(self, role: str, content: str) -> str:
        completion = self.client.chat.completions.create(model=self.__MODEL, store=True, messages=[
            {
                "role": "system",
